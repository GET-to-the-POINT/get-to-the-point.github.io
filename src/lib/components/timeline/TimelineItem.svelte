...
<div class="[&>div:first-child]:mb-2">
	<div>
		...
		>
			...
			<div
				class="text-right text-gray-700 [&>span]:mr-2 [&>span]:text-sm [&>ul]:inline-block [&>ul>li]:inline-block [&>ul>li]:rounded-full [&>ul>li]:bg-gray-200 [&>ul>li]:px-2 [&>ul>li]:py-1 [&>ul>li]:text-xs [&>ul>li]:font-semibold"
			>
				<span>작성자</span>
				<ul>
