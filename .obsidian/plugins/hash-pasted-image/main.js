	...
	generateNewName(file) {
		return (
			hash(
				...
				file.name + /* @__PURE__ */ new Date().toString()
			) +
			'.' +
			file.extension
		);
	...
	display() {
		...
		new import_obsidian.Setting(containerEl)
			...
			.addDropdown((dropdown) =>
				dropdown
					.addOption('sha256' /* SHA256 */, 'SHA-256')
					.addOption('sha384' /* SHA384 */, 'SHA-384')
					.addOption('sha512' /* SHA512 */, 'SHA-512')
					.addOption('md5' /* MD5 */, 'MD5')
		...
		new import_obsidian.Setting(containerEl)
			...
			.addDropdown((dropdown) =>
				dropdown
					.addOption('hex' /* HEX */, 'Hex')
					.addOption('base64url' /* BASE64URL */, 'Base64 URL')
		...
		new import_obsidian.Setting(containerEl)
			...
			.addToggle((toggle) =>
				toggle.setValue(this.plugin.settings.copyImageFileSupport).onChange(async (value) => {
